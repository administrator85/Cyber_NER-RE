...
class Evaluator:
    ...
    def _compute_metrics(self, gt_all, pred_all, types, print_results: bool = False):
        ...
        print(f"******Per type: {per_type}; gt_all: {gt_all}; pred_all: {pred_all}; types: {types}")
        if print_results:
